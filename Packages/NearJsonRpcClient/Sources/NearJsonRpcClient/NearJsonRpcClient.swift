...
public final class NearJsonRpcClient {
    ...
    internal func _rpcInvokeRawResult(method: String, params: ClientRPCParams) async throws -> Data {
    ...
    private func _serialize(_ params: ClientRPCParams) -> Any {
        ...
        case .object(let obj):
            var out: [String: Any] = [:]
            for (k, v) in obj { out[k] = _serialize(v) }
            return out
        }
    }
    ...
    private func _serialize(_ literal: ClientRPCLiteral) -> Any {
        ...
        case .object(let o): return o.mapValues { _serialize($0) }
        case .array(let a): return a.map { _serialize($0) }
...
//     }
    ...
    public func rawCall<T: Decodable>(method: String, params: Encodable?, decode: T.Type = T.self) async throws -> T {
